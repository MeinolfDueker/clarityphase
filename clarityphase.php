...
add_action('admin_init', function() {
    ...
    add_settings_section('cp_sec_brand', 'Branding', function() {
        echo '<p>Globales White-Label Branding für Portal & E-Mails.</p>';
    }, 'clarityphase_settings');
    ...
    add_settings_section('cp_sec_portal', 'Portal', function() {
        echo '<p>Links und Standardtexte.</p>';
    }, 'clarityphase_settings');

    add_settings_field('cp_portal_url', 'Portal URL', 'cp_field_portal_url', 'clarityphase_settings', 'cp_sec_portal');
    add_settings_field('cp_support_email', 'Support E-Mail', 'cp_field_support_email', 'clarityphase_settings', 'cp_sec_portal');
    add_settings_field('cp_footer_text', 'E-Mail Footer Text', 'cp_field_footer_text', 'clarityphase_settings', 'cp_sec_portal');

    add_settings_section('cp_sec_mail', 'E-Mail', function() {
        echo '<p>Absender/Reply-To/BCC für alle ClarityPhase Mails.</p>';
    }, 'clarityphase_settings');

    add_settings_field('cp_from_name', 'From Name', 'cp_field_from_name', 'clarityphase_settings', 'cp_sec_mail');
    add_settings_field('cp_from_email', 'From E-Mail', 'cp_field_from_email', 'clarityphase_settings', 'cp_sec_mail');
    add_settings_field('cp_reply_to', 'Reply-To', 'cp_field_reply_to', 'clarityphase_settings', 'cp_sec_mail');
    add_settings_field('cp_bcc', 'BCC (optional)', 'cp_field_bcc', 'clarityphase_settings', 'cp_sec_mail');
});
